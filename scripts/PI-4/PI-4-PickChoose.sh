...
-Thanks for using have a good day." 0 0
    ...
    whiptail --clear --title "WINE DOWNLOAD MENU" --separate-output \
		...
		"6" "Chicken Invaders Pack		    330MB" off \
                "7" "Command & Conquer Generals+Zero Hour   2.7GB" off \
    ...
    while read -r choice  
        ...
        case $choice in
	       ...
	       6) alt-winegames "Retro-Devils_ChickenInvaders-Pack.zip" ;;
               7) download-winegames "Retro-Devils_CNCGENS-ZH.zip"; game_fix "Command-And-Conquer-fix.reg" ;;
