...
HOST4="https://archive.org/download/devils-wine_202212"
...
-Reboot system " 0 0
 whiptail --clear --title "MUGEN DOWNLOAD MENU" --separate-output \
		...
		"1" "EVE Mugen                             15.5GB" off \
		"2" "Famicon Fighters                  100 MB" off \
                "3" "Original MUGEN                      8 MB" off \
		"4" "Sonic Freedom Fighter              15 MB" off \
		"5" "SpiderMan Web Of Freedom          2.3 GB" off \
		"6" "Ultimate Sonic                    200 MB" off \
		 2>/tmp/results
    while read -r choice  
        do
        case $choice in
	       +) none ;;
	       1) download-eve "Retro-Devils_EVE-MUGEN.7z" ;;
	       2) download-mugens "Retro-Devils_Famicon-Fighters-Mugen.zip" ;;
               3) download-mugens "Retro-Devils_OG-Mugen.zip" ;;
	       4) download-mugens "Retro-Devils_Sonic-Freedom-Fighters-Mugen.zip" ;;
	       5) download-mugens "Retro-Devils_Spiderman-WoF-Mugen.zip" ;;
	       6) download-mugens "Retro-Devils_Ultimate-Sonic-Mugen.zip" ;;
	       *) ;;
        esac
        done < /tmp/results
fi
...
-Thanks for using have a good day." 0 0
    ...
    whiptail --clear --title "WINE DOWNLOAD MENU" --separate-output \
	       ...
	       "9" "F1 Spirit                               50MB" off \
               "10" "Fallout                                535MB" off \
               "11" "Fallout 2                              555MB" off \
               "12" "Fallout Tactics                        1.5GB" off \
	       "13" "Goonies Remake                          90MB" off \
               "14" "Harry Potter Prisoner of Azkaban       1.5GB" off \
               "15" "Heroes Of might And Magic 2 Gold       738MB" off \
               "16" "Heroes Of might And Magic 3            426MB" off \
               "17" "Heroes Of might And Magic 4              1GB" off \
               "18" "Hydro Thunder                           66MB" off \
	       "19" "Maze Of Galious                        100MB" off \
	       "20" "Road Fighter                            50MB" off \
               "21" "Silent Hill 2 Director's Cut           2.3GB" off \
               "22" "Silent Hill 3                          4.8GB" off \
               "23" "Silent Hill 4 The Room                 3.4GB" off \
               "24" "Spooky Castle                           10MB" off \
               "25" "Starcraft                              1.2GB" off \
               "26" "Star Wars Battlefront                  2.3GB" off \
               "27" "Street of Rage Remake v5.2             605MB" off \
	       "28" "Sugar Rush Speedway                    4.3GB" off \
               "29" "Teenage Muntant Ninja Turtles          1.3GB" off \
               "30" "The House Of The Dead                  299MB" off \
               "31" "The House Of The Dead 2                579MB" off \
    ...
    while read -r choice  
        ...
        case $choice in
	       ...
	       9) download-winegames "Retro-Devils_F1-Spirit.zip" ;;
	      ...
	      13) download-winegames "Retro-Devils_The-Goonies.zip" ;;
              14) download-winegames "Retro-Devils_HPPOA.zip" ;;
              15) download-winegames "Retro-Devils_Heroes2Gold.zip" game_fix "Heroes-of-Might-and-Magic-fix.reg" ;;
              16) download-winegames "Retro-Devils_Heroes3.zip" game_fix "Heroes-of-Might-and-Magic-fix.reg" ;;
              17) download-winegames "Retro-Devils_Heroes4.zip" game_fix "Heroes-of-Might-and-Magic-fix.reg" ;;
              18) download-winegames "Retro-Devils_HydroThunder.zip" ;;
	      19) download-winegames "Retro-Devils_Maze-Of-Galious.zip" ;;
	      20) download-winegames "Retro-Devils_RoadFighter.zip" ;; 
              21) download-winegames "Retro-Devils_SilentHill2DC.zip" ;;
              22) download-winegames "Retro-Devils_SilentHill3.zip" ;;
              23) download-winegames "Retro-Devils_SilentHill4TR.zip"; game_fix "Silent-Hill-4-The-Room-Fix.reg" ;;
              24) download-winegames "Retro-Devils_Spooky-Castle.zip" ; castle-fix ;;
              25) download-winegames "Retro-Devils_Starcraft.zip" ;;
              26) download-winegames "Retro-Devils_SWBF.zip" ;;
              27) download-winegames "Retro-Devils_Strees-of-Rage-Remake.zip" ;;
	      28) download-winegames "Retro-Devils_Sugar-Rush-Speedway.zip" ;;
              29) download-winegames "Retro-Devils_TMNT.zip" ;;
              30) download-winegames "Retro-Devils_THOTD.zip" ;;
              31) download-winegames "Retro-Devils_THOTD2.zip" ;;
