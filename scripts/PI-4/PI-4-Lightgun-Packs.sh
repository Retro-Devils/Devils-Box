...
unzip "$HOME"/RetroPie/roms/nes/Gun-Games/NES-Gun-Games.zip
sudo rm "$HOME"/RetroPie/roms/nes/Gun-Games/NES-Gun-Games.zip
...
unzip "$HOME"/RetroPie/roms/snes/Gun-Games/SNES-Gun-Games.zip
sudo rm "$HOME"/RetroPie/roms/snes/Gun-Games/SNES-Gun-Games.zip
rm -f "$HOME"/RetroPie/roms/snes/Gun-Games/Gun-Games/index.html.tmp
}
