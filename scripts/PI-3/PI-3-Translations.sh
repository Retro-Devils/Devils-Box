...
PLEASE Install/Update Devils Box" 0 0
    ...
    choice=$(dialog --backtitle "$BACKTITLE" --title " TRANSLATIONS DOWNLOAD MENU" \
      ...
      1 "Dreamcast TRANSLATIONS                 5 GAMES" \
      2 "Gameboy Color TRANSLATIONS            20 GAMES" \
      3 "Gameboy TRANSLATIONS                  59 GAMES" \
      4 "Gamegear TRANSLATIONS                 15 GAMES" \
      5 "NDS TRANSLATIONS                       1 GAMES" \
      6 "Playstation TRNASLATIONS               7 GAMES" \
      7 "Super Famicon TRANSLATIONS           232 GAMES" \
      + "<---------->LAST UPDATED 9/30/22<----------->" \
      + "<-->Credits to Official Rom Hack Database<-->" \
      2>&1 >/dev/tty)

    case "$choice" in
    1) translation-packs "dreamcast" "Dreamcast-Translations" ;;
    2) translation-packs "gbc" "Gameboy-Color-Translations" ;;
    3) translation-packs "gb" "Gameboy-Translations" ;;
    4) translation-packs "gamegear" "Gamegear-Translations" ;;
    5) translation-packs "nds" "NDS-Translations" ;;
    6) translation-packs "psx" "Playstation-Translations" ;;
    7) translation-packs "sfc" "Super-Famicon-Translations" ;;
     +) none  ;;
     *) break ;;
    esac
   done
