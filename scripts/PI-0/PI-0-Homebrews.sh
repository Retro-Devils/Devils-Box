...
PLEASE Install/Update Devils Box" 0 0
    ...
    choice=$(dialog --backtitle "$BACKTITLE" --title " HOMEBREWS DOWNLOAD MENU" \
      ...
      2 "Gameboy Advance HOMEBREWS            1 GAMES" \
      3 "Gameboy Color HOMEBREWS             41 GAMES" \
      4 "Gameboy HOMEBREWS                  47 GAMES" \
      5 "Genesis HOMEBREWS                   9 GAMES" \
      6 "Gamegear HOMEBREWS                  2 GAMES" \
      7 "NES HOMEBREWS                     143 GAMES" \
      8 "SNES HOMEBREWS                    33 GAMES" \
    ...
    2) homebrew-packs "gba" "Gameboy-Advance-Homebrews" ;;
    3) homebrew-packs "gbc" "Gameboy-Color-Homebrews" ;;
    4) homebrew-packs "gb" "Gameboy-Homebrews" ;;
    5) homebrew-packs "genesis" "Gamegear-Homebrews" ;;
    6) homebrew-packs "gamegear" "Genesis-Homebrews" ;;
    7) homebrew-packs "nes" "NES-Homebrews" ;;
    8) homebrew-packs "snes" "SNES-Homebrews" ;;
     +) none  ;;
     *) break ;;
    esac
   done
