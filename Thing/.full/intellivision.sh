...
sudo rm -r /home/pi/RetroPie/roms/intellivision
cd
mkdir test
cd test
wget -c https://archive.org/download/thing-box/Retro-Devils-Intellivision.7z -q --show-progress
7z x -y -aoa /home/pi/test//Retro-Devils-Intellivision.7z
sudo mv intellivision /home/pi/RetroPie/roms
sudo rm "/Retro-Devils-Intellivision.7z"
cd ..
sudo rm -R test
