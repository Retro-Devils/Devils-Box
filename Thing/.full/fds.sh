...
sleep 2
wget --spider https://archive.org/download/thing-box/Retro-Devils-fds.7z
...
mkdir test
cd test
wget -c https://archive.org/download/thing-box/Retro-Devils-fds.7z -q --show-progress
7z x -y -aoa /home/pi/test/Retro-Devils-fds.7z
sudo mv fds /home/pi/RetroPie/roms
sudo rm "Retro-Devils-fds.7z"
cd ..
sudo rm -R test
