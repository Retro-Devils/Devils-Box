...
BACKTITLE="My name is... Shake-Zula. The mic-rula, The old schoolah, Ya wanna trip? I'll bring it to ya		Hello. My name is Inigo Montoya. You killed my father. Prepare to die."		
#-----------COLORS----------#
rst="$(tput sgr0)"
